...
values
    ...
    ('AppleBees', '465 South Road, Kennesaw, GA, 30152', '456 South Road', 'Kennesaw', 'Georgia', '4041231234', 'https://www.applebees.com/en/menu/pasta-seafood-and-more', 'https://www.alexslemonade.org/sites/default/files/ab_brand_refresh_logo_cmyk_gray_r.png' ),
...
values
    (4, 'The char on my steak was as black as my soul. Cant recommend ths place enough!', 3, 3),
    (4, 'The char on my steak was as black as my soul. Cant recommend ths place enough!', 3, 3),
    (4, 'The char on my steak was as black as my soul. Cant recommend ths place enough!', 3, 3),
    (5, 'I like the water that was yellow and bubbly. Ive never had Coors b4!', 1, 4),
    (1, 'Never in my(very long) life have I had such a bad meal. I dont know where the chef studied, but the cuisine has a hallmark Durmstang flavor to it. Blech!', 2, 1),
    (3, 'Not my black forest cake, but certainly serviceable. A little fussy looking, but tastes just fine once you strip away all hte dressing', 2, 1)
;
